...
// Tạo đơn hàng lưu trữ trong Map và gửi tin nhắn đến hàng đợi "orders"
  async createOrder(req, res, next) {
    ...
    // Lắng nghe tin nhắn từ hàng đợi "products" để cập nhật trạng thái đơn hàng
...
// Lấy trạng thái đơn hàng từ Map dựa trên orderId
